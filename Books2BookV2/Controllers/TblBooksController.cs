...
namespace Books2BookV2.Controllers
{
    ...
    public class TblBooksController : Controller
    {
            ...
            DateTime datePublished, int numTimesRated,  float averageRating, string pdflink)
        {
            ...
            TblBook tblBook = new TblBook(default, ISBN, title
                , Category, true, edition, pages, condition, numberOfTimesBorrowed, 
                description, ratingTotal, DateTime.Today, numTimesRated, averageRating, pdflink);
